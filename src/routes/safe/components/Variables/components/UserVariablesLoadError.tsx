...
const UserVariablesLoadError = (): React.ReactElement => {
  ...
  return (
    <Wrapper>
      <Content>
        <Title size="md">Safe Variable could not be loaded.</Title>
        ...
        <Link size="lg" color="primary" onClick={handleGoBack}>
          Go back to the Safe Variables list
        </Link>
      </Content>
    </Wrapper>
  )
...
export default UserVariablesLoadError
